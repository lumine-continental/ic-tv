...
const ALL_CARRERAS = [
  { id: 1, area: 'negocios', nombre: 'Administración de Empresas', desc: 'Lidera organizaciones y gestiona recursos para el éxito empresarial global.', icon: Building2, videoUrl: 'https://www.youtube.com/watch?v=cT_W0dHJ-M0' },
  { id: 2, area: 'negocios', nombre: 'Contabilidad', desc: 'Domina las finanzas y toma decisiones estratégicas basadas en datos.', icon: Calculator, videoUrl: 'https://youtu.be/cj1pFbDqyYc' },
  ...
  { id: 3, area: 'tecnologia', nombre: 'Desarrollo de Sistemas', desc: 'Crea software, aplicaciones y soluciones tecnológicas del futuro.', icon: Laptop, videoUrl: 'https://www.youtube.com/watch?v=r2G3T7UvBLI' },
