      ...
      <div className="relative w-full max-w-6xl aspect-[21/9] glass-panel overflow-hidden">
        ...
        {selectedCountry && (
          <div className="absolute inset-0 flex items-center justify-center p-4 md:p-8 z-20">
            <div className="bg-black/60 backdrop-blur-2xl rounded-[32px] border border-white/20 shadow-2xl p-6 md:p-8 max-w-xl w-full flex flex-col items-center text-center gap-4">
